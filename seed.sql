...
(2, 'Health', 'Health is a measure of how much damage you can take before dying.'),
(3, 'Intelligence', 'Intelligence is a measure of how well you can think and reason.'),
(4, 'Dexterity', 'Dexterity is a measure of hand-eye coordination and agility.')
...
(1, 1, 3),  -- Fireball depends on Intelligence
(2, 1, 4),  -- Fireball also depends on Dexterity
(3, 2, 3),  -- Heal depends on Intelligence
(4, 2, 4);  -- Heal depends on Dexterity
...
-- Wizzard
(1, 1, 3, 1.1),  -- Intelligence modifier for Wizard
(2, 1, 4, 1.0),  -- Dexterity
-- Rogue
(3, 2, 4, 1.15); -- Dexterity
...
-- Character 1 - Wizzard
(1, 1, 2, 100), -- HEALTH
(2, 1, 3, 10),  -- INTELLIGENCE
(3, 1, 4, 5),   -- DEXTERITY
-- Character 2 - Rogue
(4, 2, 2, 100), -- HEALTH
(5, 2, 3, 5), -- INTELLIGENCE
(6, 2, 4, 10); -- DEXTERITY
...
(1, 1, 1, 100, 50), -- Character 1 in combat with full health and action points
...
(1, 1, 1, 5), -- +5 Armor
(2, 1, 2, 10), -- +10 Health
(3, 1, 3, 5), -- +5 Intelligence
-- Cloak of Agility
(4, 2, 1, 10), -- +10 Armor
(5, 2, 4, 3), -- +3 Dexterity
-- Necklace of Necromancy
(6, 3, 1, 3), -- +3 Armor
(7, 3, 3, 10), -- +10 Intelligence
-- Moon Steel Chest plate
(8, 4, 1, 20), -- +20 Armor
(9, 4, 4, 10); -- +10 Dexterity
